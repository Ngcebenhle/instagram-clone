class App 
{
  ...
  handleSipleUpload(){
    ...
    handleUpdateUpload(id){
      ...
      if(this.selectedToUpdateImage.files[0]){

            // 'file' comes from the Blob or File API
            ImagesRef.put(this.files[0])
            .then((snapshot) => {
              console.log('Uploaded a blob or file!');
          ...
          this.selectedToUpdateImage.onchange = e => 
            {
              ...
              reader.addEventListener("load", () =>{
                ...
                this.imageDisplayToChangediv = document.querySelector('.updateImage');
    ...
    //       <span class="profile-name">${doc.data().PostUserName}</span>
    //     </div>
    ...
    //     <span class="caption">
    //       <span class="caption-username"><b>${doc.data().PostUserName}</b></span>
    ...
    //   let PostList = document.getElementById('ownPostholder');
    
    //   const myposts = document.createElement("div");
      
    //   // myposts.setAttribute('id','ownPost');
    //     myposts.innerHTML =  post;
    //     myposts.style.backgroundColor = 'blue'
    //     // myposts.style.width = '100%'
    //     // myposts.style.height = '100%'

      
    //   const ownPostList = document.getElementById('ownPost');
      
    //   ownPostList.append(myposts)



    //   // const ownPostList = document.getElementById('ownPost');
    //   // ownPostList.innerHTML =  post;

    //   PostList.appendChild(myposts)
             ...
             moreIcon.addEventListener('click',()=>{
              ...
              this.edit.addEventListener('click',() =>{
                ...
                this.imageDisplayToChange.addEventListener("click",() =>{ 
                  ...
                  this.selectedToUpdateImage.onchange = e => 
                    ...
                    this.img = this.selectedToUpdateImage.file[0]
                 }); 
              ...
              //  var imageview = document.querySelector('#display').style.display = "none";
                ...
                this.Update.addEventListener('click', () => {
                  ...
                  this.handelmageSelect()
                  this.handleUpdateUpload(doc.id,this.img);
                  this.handleRefresh();
