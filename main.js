class App {
  constructor() {
   ...
   this.auth = firebase.auth();
    ...
    this.create.addEventListener("click", () => {
      ...
      const imageSelectIcon = document.querySelector(".uploadbuttonicon");
  ...
  handelmageSelect() {
    //Image select button
    const imageSelect = document.querySelector(".uploadbuttonicon");
      ...
      this.selectedImage.onchange = (e) => {
        ...
        reader.addEventListener("load", () => {
          ...
          // imageDisplay.style.backgroundImage = `url(${uploaded_image})`;
              imageDisplay.src = uploaded_image;
        ...
        this.imageDisplayToChange.addEventListener("click", () => {
          ...
          this.selectedToUpdateImage.onchange = (e) => {
            ...
            reader.addEventListener("load", () => {
              ...
              this.imageDisplay.src =uploaded_image;
